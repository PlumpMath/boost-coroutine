...
#ifndef BOOST_CORO_DETAIL_CONTEXT_BASE_START_H
#define BOOST_CORO_DETAIL_CONTEXT_BASE_START_H
...
struct context_base_start;

template< typename Signature, typename D >
struct context_base_start< Signature, D, void, 0 >
{
    void start()
    {
...
template< typename Signature, typename D > \
struct context_base_start< Signature, D, void, n > \
{ \
...
#endif // BOOST_CORO_DETAIL_CONTEXT_BASE_START_H
